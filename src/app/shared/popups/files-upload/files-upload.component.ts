...
export class FilesUploadComponent implements OnInit {
  ...
  // como resultado de subir las imagenes a un servidor en cloud este me devolvera unas urls para 
  // despues tener acceso  a las imagenes
